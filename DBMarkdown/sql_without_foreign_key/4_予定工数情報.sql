CREATE TABLE [dbo].[sh_t_plans_production_costs_info] (
...
EXEC sys.sp_addextendedproperty  @name=N'MS_Description',@value=N'予定工数情報',@level0type=N'SCHEMA',@level0name=N'dbo',@level1type=N'TABLE',@level1name=N'sh_t_plans_production_costs_info'
EXEC sys.sp_addextendedproperty  @name=N'MS_Description',@value=N'PRNo.',@level0type=N'SCHEMA',@level0name=N'dbo',@level1type=N'TABLE',@level1name=N'sh_t_plans_production_costs_info',@level2type=N'COLUMN',@level2name=N'project_number'
...
EXEC sys.sp_addextendedproperty  @name=N'MS_Description',@value=N'分割受注金額或いは受注金額',@level0type=N'SCHEMA',@level0name=N'dbo',@level1type=N'TABLE',@level1name=N'sh_t_plans_production_costs_info',@level2type=N'COLUMN',@level2name=N'order_amount'
...
EXEC sys.sp_addextendedproperty  @name=N'MS_Description',@value=N'外注費有無:0なし、1あり、2未選択',@level0type=N'SCHEMA',@level0name=N'dbo',@level1type=N'TABLE',@level1name=N'sh_t_plans_production_costs_info',@level2type=N'COLUMN',@level2name=N'outsourcing_cost_flag'
...
EXEC sys.sp_addextendedproperty  @name=N'MS_Description',@value=N'作成者コード',@level0type=N'SCHEMA',@level0name=N'dbo',@level1type=N'TABLE',@level1name=N'sh_t_plans_production_costs_info',@level2type=N'COLUMN',@level2name=N'create_user_cd'
