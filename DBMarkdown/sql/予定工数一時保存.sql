...
EXEC sys.sp_addextendedproperty  @name=N'MS_Description',@value=N'部署コード',@level0type=N'SCHEMA',@level0name=N'dbo',@level1type=N'TABLE',@level1name=N'sh_t_plans_production_costs_saved',@level2type=N'COLUMN',@level2name=N'department_cd'
...
EXEC sys.sp_addextendedproperty  @name=N'MS_Description',@value=N'外注費有無',@level0type=N'SCHEMA',@level0name=N'dbo',@level1type=N'TABLE',@level1name=N'sh_t_plans_production_costs_saved',@level2type=N'COLUMN',@level2name=N'progress_cost_flag'
...
EXEC sys.sp_addextendedproperty  @name=N'MS_Description',@value=N'削除フラグ',@level0type=N'SCHEMA',@level0name=N'dbo',@level1type=N'TABLE',@level1name=N'sh_t_plans_production_costs_saved',@level2type=N'COLUMN',@level2name=N'delete_flag'
