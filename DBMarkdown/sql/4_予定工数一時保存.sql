...
EXEC sys.sp_addextendedproperty  @name=N'MS_Description',@value=N'外注費有無:1なし、2あり',@level0type=N'SCHEMA',@level0name=N'dbo',@level1type=N'TABLE',@level1name=N'sh_t_plans_production_costs_saved',@level2type=N'COLUMN',@level2name=N'progress_cost_flag'
