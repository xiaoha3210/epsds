...
EXEC sys.sp_addextendedproperty  @name=N'MS_Description',@value=N'売上調有無',@level0type=N'SCHEMA',@level0name=N'dbo',@level1type=N'TABLE',@level1name=N'sh_t_salses_saved',@level2type=N'COLUMN',@level2name=N'sales_adjusted_change_flag'
...
EXEC sys.sp_addextendedproperty  @name=N'MS_Description',@value=N'終了フラグ',@level0type=N'SCHEMA',@level0name=N'dbo',@level1type=N'TABLE',@level1name=N'sh_t_salses_saved',@level2type=N'COLUMN',@level2name=N'end_flag'
...
EXEC sys.sp_addextendedproperty  @name=N'MS_Description',@value=N'削除フラグ',@level0type=N'SCHEMA',@level0name=N'dbo',@level1type=N'TABLE',@level1name=N'sh_t_salses_saved',@level2type=N'COLUMN',@level2name=N'delete_flag'
