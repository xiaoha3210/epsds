CREATE TABLE [dbo].[sh_t_order_details] (
  ...
  , [expected_days_before_divided] int default NULL
...
EXEC sys.sp_addextendedproperty  @name=N'MS_Description',@value=N'予定工数(按分前)',@level0type=N'SCHEMA',@level0name=N'dbo',@level1type=N'TABLE',@level1name=N'sh_t_order_details',@level2type=N'COLUMN',@level2name=N'expected_days_before_divided'
