...
EXEC sys.sp_addextendedproperty  @name=N'MS_Description',@value=N'受注ステータスコード:1仮受注、2本受注、3受注終了',@level0type=N'SCHEMA',@level0name=N'dbo',@level1type=N'TABLE',@level1name=N'sh_t_order_list',@level2type=N'COLUMN',@level2name=N'order_status_cd'
