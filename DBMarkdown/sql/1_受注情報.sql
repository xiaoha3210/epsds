CREATE TABLE [dbo].[sh_t_order_list] (
  ...
  , [order_name] nvarchar(10) default NULL
...
EXEC sys.sp_addextendedproperty  @name=N'MS_Description',@value=N'受注名:1仮受注、2本受注、3受注終了',@level0type=N'SCHEMA',@level0name=N'dbo',@level1type=N'TABLE',@level1name=N'sh_t_order_list',@level2type=N'COLUMN',@level2name=N'order_name'
